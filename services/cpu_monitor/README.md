...
Для CPU Monitor предусмотрены готовые скрипты установки и запуска для различных операционных систем. Это рекомендуемый способ для быстрого развёртывания агента на хосте.
...
# Установка и запуск одним скриптом (рекомендуется)
chmod +x install_and_run.sh
./install_and_run.sh
```

Скрипт `install_and_run.sh`:
- Создаёт изолированное виртуальное окружение `.venv_cpu_monitor`
...
:: Только запуск (после установки)
run_agent.bat
```

### Ручная установка и запуск

Если вы предпочитаете ручную настройку или хотите использовать собственные параметры:
